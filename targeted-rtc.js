/* mca-rtc.js — Fieldhouse Creative (AEHub) NATIVE video conferencing (own WebRTC, no third party)
   ------------------------------------------------------------------------
...
(function () {
  ...
  var API = (window.TARGETED_API||'https://ae-connect-api.vercel.app')+'/api/connect';
  ...
  window.ShowroomMeet = ESPOAPI; window.MCAMeet = ESPOAPI; window.ESPOMeet = ESPOAPI; window.LCPMeet = ESPOAPI;
})();
